...
@WebMvcTest(MultiplicationResultAttempltController.class)
public class MultiplicationResultAttemptControllerTest {
    ...
    private JacksonTester<MultiplicationAttempt> jsonResultAttempt;
    ...
    void genericParameterizedTest(final boolean correct) throws Exception {
        ...
        given(multiplicationService
                .checkAttempt(any(MultiplicationAttempt.class)))
                .willReturn(correct);
        MultUser user = new MultUser("john");
        Multiplication multiplication = new Multiplication(50, 70);
        MultiplicationAttempt attempt = new MultiplicationAttempt(
        ...
        assertThat(response.getContentAsString()).isEqualTo(
                jsonResultAttempt.write(
                        new MultiplicationAttempt(attempt.getUser(),
    ...
    public void getUserStats() throws Exception {
        // given
        MultUser user = new MultUser("john_doe");
        Multiplication multiplication = new Multiplication(50, 70);
        MultiplicationAttempt attempt = new MultiplicationAttempt(
